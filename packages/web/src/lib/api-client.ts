...
export class ApiClient {
  ...
  /** Phase 16: aggregate spend breakdown by scope/feature/provider/model/role (issue #66). */
  ...
  /** Phase 16: the merged chronological history for one feature run (issue #66). */
