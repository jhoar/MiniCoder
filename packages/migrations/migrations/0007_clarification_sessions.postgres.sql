...
ALTER TABLE planning_gaps ADD COLUMN IF NOT EXISTS clarification_session_id TEXT REFERENCES clarification_sessions(id);
ALTER TABLE planning_assumptions ADD COLUMN IF NOT EXISTS clarification_session_id TEXT REFERENCES clarification_sessions(id);
