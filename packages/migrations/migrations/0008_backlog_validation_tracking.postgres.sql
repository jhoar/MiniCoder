...
ALTER TABLE implementation_plans ADD COLUMN IF NOT EXISTS backlog_version INTEGER NOT NULL DEFAULT 0;
ALTER TABLE implementation_plans ADD COLUMN IF NOT EXISTS backlog_validated_at TIMESTAMPTZ;
ALTER TABLE implementation_plans ADD COLUMN IF NOT EXISTS backlog_validated_state TEXT;
ALTER TABLE implementation_plans ADD COLUMN IF NOT EXISTS backlog_validated_version INTEGER;
...
ALTER TABLE clarification_sessions ADD COLUMN IF NOT EXISTS assessment_id TEXT REFERENCES planning_readiness_assessments(id);
